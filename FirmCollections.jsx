...
const FirmCollections = () => {
  ...
  return (
    <>
      <h3>Restaurants with online food delivery in Mumbai</h3>
      <div className="filterButtons">
        <button onClick={() => filterHandler("All", 'all')} className={activeCategory === 'all' ? 'activeButton': ''}>All</button>
        <button onClick={() => filterHandler("Pure Veg" , 'pure-veg')} className={activeCategory === 'pure-veg' ? 'activeButton': ''} >Pure-Veg</button>
